  ...
  void completedLevel(GJGameLevel *p0) {
    ...
    if (!Mod::get()->getSavedValue<bool>("hasRead")) {
      geode::MDPopup::create(
          ...
          "servers.\n\n"
          "<cy>3.</c> You can delete your account data from the backup server "
          "by clicking the <cg>DELETE</c> button at any time.\n\n"
          "<cy>4.</c> Your data will be used solely for backup purposes and "
          "will not be shared with anywhere else.\n\n"
          "<cy>5.</c> You accept that there's a possibility of risk when using "
          "this service.\n\n"
          ...
          "backup solution for your account! Please use the <cg>main "
          "backup</cg> in the game.</c>\n\n"
